...
(function (global, factory) {
    ...
    function histogram() {
        ...
        function histogram(data) {
            ...
            // Remove any thresholds outside the entity.
            var m = tz.length;
            ...
            // Assign data to bins by value, ignoring any outside the entity.
            for (i = 0; i < n; ++i) {
                x = values[i];
                if (x0 <= x && x <= x1) {
    ...
    // deinterpolate(a, b)(x) takes a entity value x in [a,b] and returns the corresponding parameter t in [0,1].
    // reinterpolate(a, b)(t) takes a parameter t in [0,1] and returns the corresponding entity value x in [a,b].
    ...
    function calendar(year, month, week, day, hour, minute, second, millisecond, format) {
        ...
        function tickInterval(interval, start, stop, step) {
            ...
            // based on the extent of the entity and a rough estimate of tick size.
