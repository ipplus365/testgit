                ...
                <div class="form" v-show="firstSuccess">
                    ...
                    <div class="item">
                        ...
                        <div class="fl">
                            ...
                            <div class="clr"></div>
                            <div id="countDown" class="msg-text" v-show="isGet">校验码已发出，请注意查收邮件，如果没有收到，你可以在<strong class="ftx-01">12</strong>小时后要求系统重新发送</div>
            ...
            subNewPwd:function (){
                ...
                if(this.checkPwd() && this.checkPwdRe()){
                    $.ajax({
                        ...
                        url:"/user/resetPwd",
                        async:true,
                        data:{email:self.email,newPwd:self.newPwd,confirmPwd:self.newPwdRe},
                        datatype:'json',
                        success:function(res){
                            console.log(res);
                            if(res.success){
