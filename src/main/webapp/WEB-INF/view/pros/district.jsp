...
<div id="main">
    <div class="main_inner">
        <div class="left">
            ...
            <li class="four">
                <img src="/statics/images/t_s_title4.png"/>
                IP BT
                <ul class="list">
                    <li class="active">BT任务<i class="iconfont">&#xe601;</i></li>
                    <li class="last">BT下载者<i class="iconfont">&#xe601;</i></li>
                </ul>
            </li>
        </div>
        <!--购买页面区县库部分 开始-->
        <div class="right district">
            ...
            <div class="API_slide">
                ...
                <li>
                    ...
                    <span class="normal size14 light district_api_single">¥<em class="orange size18 bold">1920.00</em>/次</span>
                    <span class="normal light ml50 size14 free_tips" style="display: none;">*2017年12月1日优惠结束</span>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul class="time_list district_API_three">
                        <li districtApiYear='1' class="active">1年</li>
                        <li districtApiYear='2'>2年</li>
                        <li districtApiYear='3' class="last">3年</li>
                    </ul>
                    <ul class="district_API_one" style="display: none;">
                        <li districtApiYear='1' class="active last">1年</li>
                    </ul>
